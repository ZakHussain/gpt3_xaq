    ...
    return (
        <div className="gpt3__features section__padding" id="features">
            ...
            <div className="gpt3__features-container">
                <Feature title="Improving and distrusts instantly" text="From they fine john he give of rich he. They age and draw mrs like. Improving end distrusts may instantly was household applauded."/>
                ...
                <Feature title="really how are you" text="Really boy law county she unable her sister. Feet you off its like like six. Among sex are leave law built now. In built table in an rapid blush."/> 
            </div>
        </div>
    )
}
